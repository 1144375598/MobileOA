...
/**
 * Created by minxing on 2017-05-02.
 */
...
public class CalendarHelper {
    ...
    private static String CALENDARS_NAME = "MobileOA";
    private static String CALENDARS_ACCOUNT_NAME = "MobileOA@gmail.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.exchange";
    private static String CALENDARS_DISPLAY_NAME = "MobileOA";
